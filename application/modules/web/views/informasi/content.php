						...
						<div style="margin-left: 20px;text-align: justify;" class="world-news-grids">
							<div class="grid box">
								<div class="grid-header">
									<a style="" class="gotosingle" href="<?php echo base_url().'web/detail_informasi/'.$daftar->id; ?>"><?php echo $daftar->judul; ?> </a>
									<ul>
								...
								<div class="grid-img-content">
									<a href="<?php echo base_url().'web/detail_informasi/'.$daftar->id; ?>">
										<!-- <img style="width: 300px;height: 225px;" src="<?php echo base_url().'component/upload/foto/uploads/'.str_replace("|","",$daftar->foto); ?>" class="blog respon" alt="" /> -->
								...
								<div class="comments">
									<ul>
										...
										<!-- <li><a class="readmore"   key="<?php echo $daftar->id;?>" href="<?php echo base_url().'web/detail_informasi/'.$daftar->id; ?>">ReadMore</a></li>
									-->
