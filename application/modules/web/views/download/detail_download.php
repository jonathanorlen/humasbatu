			...
			<div class="col-md-12">
				<div class="world-news">
					<div class="main-title-head">
						...
						$hasil = $this->db->query(" SELECT * FROM download where id= '$id' ");
					...
					<div style="margin-bottom:30px">
						...
						<div style="text-align:justify;">
							...
							<h5 style="margin-top: 15px"><a download href="<?php echo base_url() . 'component/upload/foto/uploads/'.str_replace('|',"",$hasil_ambil->foto); ?>" style="background-color:#3c763d;padding:5px;border-radius:5px;font-weight:bold;color:white;text-decoration:none" >FILE DOWNLOAD</a>
							</h5>
						</div>
					</div>
				...
				<div class="world-news">
					<div class="main-title-head">
						...
						<a href="<?php echo base_url().'web/download/'.$hasil_ambil->jenis_dokumen; ?>">Artikel Lainnya +</a>
						<div class="clearfix"></div>
					</div>
					<div class="world-news-grids">
						...
						$this->db->where('jenis_dokumen',$hasil_ambil->jenis_dokumen);
						$artikel = $this->db->get('download');
						foreach($artikel->result() as $daftar){
							...
							<div class="world-news-grid">
								...
								<a key="<?php echo $daftar->id?>" class="title tambah"><?php echo substr($daftar->judul,0,7); ?></a>
