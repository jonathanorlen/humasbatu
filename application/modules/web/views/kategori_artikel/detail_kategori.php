				...
				<div class="world-news-grids">
					...
					foreach($artikel->result() as $daftar){
						...
						<div class="world-news-grid">
							...
							<a href="<?php echo base_url().'web/detail_artikel/'.$daftar->id; ?>" class="title"><?php echo substr($daftar->judul,0,7); ?></a>
					...
					<div class="comments">
						...
						foreach($get_komentar->result() as $daftar){
							...
							<div class="comment-wrap">
								<div class="photoku">
									<img style="border-radius: 40px;width: 100%;height:20%;max-width: 100px;max-height:80px;" class="avatar" src="<?php echo base_url().'component/web/images/avatar.png' ?>" />
