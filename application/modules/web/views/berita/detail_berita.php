		...
		<div class="posts">
			<div class="col-md-12">
				<div class="world-news">
					...
					?>
					<div>
						<!-- <img src="<?php echo base_url() . 'component/upload/foto/uploads/'.$name_img; ?>" class="img-responsive" alt="" width="100%" style="align-self:center"/> -->
				...
				<div class="world-news-grids">
					...
					foreach($artikel->result() as $daftar){
						...
						<div class="world-news-grid">
							...
							<a href="<?php echo base_url().'web/detail_berita/'.$daftar->id; ?>" class="title"><?php echo substr($daftar->judul,0,7); ?></a>
