			...
			<div class="col-md-12">
				<div class="world-news">
					<div class="main-title-head">
						<h3>Struktur Organisasi Humas</h3>
					...
					<?php
					$this->db->limit(1, 0);
					$get = $this->db->get_where('struktur_humas');
					...
					foreach ($hasil_get as $item) {
						...
						<img style="width: 100%; height: auto; max-height:75%; zoom:10px;" class="img-responsive" src="<?php echo
						...
						<div style="margin-left: 20px;text-align: justify;" class="world-news-grids">
							<?php
							$humas = $this->db->get('struktur_humas');
							$hasil_humas = $humas->row();
							echo $hasil_humas->isi;
							?>
							<div class="clearfix"></div>
						</div>
					</div>
