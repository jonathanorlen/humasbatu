	...
	<div class="main-content" style="margin-top: 20px;">		
				...
				<div class="col-md-12">
					<div class="world-news">
						<div class="main-title-head">
							<h3>Sejarah Kota Wisata Batu</h3>

							<div class="clearfix"></div>
						</div>

						<div style="margin-left: 10px;text-align: justify;" class="world-news-grids">
							<?php
							$sejarah = $this->db->get('sejarah_kota');
							$hasil_sejarah = $sejarah->row();
							echo $hasil_sejarah->isi;
							?>
							<div class="clearfix"></div>
						</div>
					</div>
		...
		<div class="col-md-3 side-bar">
				...
				<!-- 	<br>
					<video width="100%" height="auto" class="wp-video-shortcode" id="video-2945-1" preload="metadata" controls="controls">
