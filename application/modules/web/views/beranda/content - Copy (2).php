...
<div class="main-content">		
	<div class="col-md-12 total-news">
			...
			<script>
						...
						<div id="slider" class="" style=";border: 1px; width: auto; position: relative; margin-bottom: 30px;" >
							<figure>
								<?php
								...
								foreach ($hasil_get as $item) {
									...
									?>
									<img src="<?php echo base_url() . 'component/upload/foto/uploads/' . $name_img;?>" style="height:420px;" alt="">
									<?php } ?>
								</figure>
							</div> -->
							<style type="text/css">
						...
						<div class="col-md-9 total-news">
							...
							<div class="world-news">
								<div class="main-title-head">
									<h3 style="background-color:#68af4a;font-size:13;padding:8px;color:white">Berita Terbaru</h3>
								...
								foreach ($hasil_get as $item) {
									...
									<div class="world-news-grids" style="border-bottom:1px solid #eaeaea;padding-bottom:8px;margin-bottom:5px;" >
										...
										<div style="margin-left:214px"> 
											<a href="#" class="title"><?php echo substr($item['judul'],0,35);?> </a>
											<p><?php echo substr($item['isi'],0,35);?></p>
											<a class="readmore tambah" key="<?php echo $item['id']; ?>" style="padding: 3px 7px;background-color:#68af4a !important;color:white;margin-top:4px;float:left;list-style:none;outline:none;text-decoration:none">Read More </a>
										</div>
										<div class="clearfix"></div>
									</div>
									<?php } ?>
									...
									foreach ($hasil_get as $item) {
										...
										<div class="world-news-grids" style="border-bottom:1px solid #eaeaea;width:250px;padding-bottom:5px;margin-left:20px;margin-bottom:10px;float:left">
											<div class="world-news-grid">
												<img style="width:65px;height:65px" src="<?php echo
												base_url() . 'component/upload/foto/uploads/' . $name_img; ?>" alt="" />
											</div>
									...
									<div class="latest-articles">
										<div class="main-title-head" style="margin-top:300px"> 
										...
										foreach ($hasil_get as $item) {
											...
											<ul>
												...
												<li>
													<a key="<?php echo $item['id']?>" class="detail" style="cursor: pointer; padding: 3px 7px;background-color:#68af4a !important;color:white;margin-top:4px;float:left;list-style:none;outline:none;text-decoration:none">Read More </a>
												</li>
											</ul>
										</div>
										<?php } ?>
										...
										<div class="tech-news-grids" >
											...
											foreach ($hasil_get as $item) {
												...
												<div class="left-tech-news" style="border-bottom:1px solid #eaeaea;padding-bottom:-10px;float: right;width:45%;">
													...
													<div class="tech-news-grid span_66" style="margin-left:70px;border-bottom: 0px;cursor: pointer;">
														...
														?>
														<p><!-- by<a href="#">John Doe </a>  |  --> <?php echo count($hasil)?> comments</p>
													</div>
												<!-- <div class="tech-news-grid">
													<a href="#">SAMBUTAN PRESIDEN REPUBLIK INDONESIA PADA ACARA PERINGATAN HARI BELA NEGARA TAHUN 2016 2</a>
											...
											<!-- <div class="right-tech-news">
												<div class="tech-news-grid span_66">
													<a href="#">SAMBUTAN PRESIDEN REPUBLIK INDONESIA PADA ACARA PERINGATAN HARI BELA NEGARA TAHUN 2016 3</a>
													<p>Nulla quis lorem neque, mattis venenatis lectus. In interdum ullamcorper dolor ... </p>
													<p>by<a href="#">John Doe </a>  |  29 comments</p>
												</div>
												<div class="tech-news-grid">
													<a href="#">SAMBUTAN PRESIDEN REPUBLIK INDONESIA PADA ACARA PERINGATAN HARI BELA NEGARA TAHUN 2016 4</a>
													<p>Nulla quis lorem neque, mattis venenatis lectus. In interdum ullamcorper dolor ... </p>
													<p>by<a href="#">John Doe </a>  |  29 comments</p>
												</div>
											</div> -->
											...
											<div class="desk-grid">
												...
												<div class="desk-grid"><br /><br />
													...
													foreach($artikel->result() as $daftar){
														...
														<ul style="margin-left: 10px; font-size: 14px;">
															<li><a key="<?php echo $daftar->id?>" class="terbaru"><?php echo $daftar->judul; ?></a></li>
														</ul>
														<?php } ?>
													</div>
						...
						<div class="clearfix"></div>
								<!-- <div class="main-title-head" style="margin-top: 30px;">
									<h5 style="background-color:#68af4a;padding:8px"><b style="color:#fff;font-size:13px;font-family:arial,Georgia, serif;height">	 TERBAIK</b></h5>
									<h4></h4>
									<div class="clearfix"></div>
								</div> -->
								...
								<!-- <div class="col-md-4">
									...
									<div class="world-news-grids">
										...
										foreach ($hasil_get as $item) {
											...
											<div class="world-news-grid" style="width:278px"> 
												...
												<a href="<?php echo base_url().'web/detail_informasi/'.$item['id']; ?>" style="padding: 3px 7px;background-color:#68af4a !important;color:white;margin-top:4px;float:left;list-style:none;outline:none;text-decoration:none;font-weight:500;cursor:pointer;margin-top:5px">Read More</a>
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="col-md-4">
											...
											<div class="clearfix"></div>
											<div class="col-md-12 total-news" style="margin-top: 40px;">
												<div class="posts">
													<div class="col-md-12">
														<div class="world-news">
																			...
																			<div class="world-news-grids">
																				...
																				foreach ($hasil_get as $item) {
																					...
																					<div class="" style="">
																								...
																								<a href="#" class="title"><?php echo substr($item['judul'],0,25);?></a>
																								<p><?php echo substr($item['judul'],0,45);?> <a class="tambah" key="<?php echo $item['id']; ?>" style="background-color: #68af4a;padding:4px;color:white;font-size:13px;text-decoration:none;cursor:pointer">READ MORE</a></p>
																							...
																							foreach ($hasil_get as $item) {
																								...
																								<div class="world-news" style="border-bottom:1px solid #eaeaea;padding-bottom:3px">
																									<div class="world-news-grids">
																										...
																										<div >
																											<a href="#" class="title"><?php echo substr($item['judul'],0,30)?></a>
																							...
																							<div class="world-news-grids">
																								...
																								foreach ($hasil_get as $item) {
																									...
																									<div class="">
																										...
																										<a href="#" class="title"><?php echo substr($item['judul'],0,35)?></a>
																										<p><?php echo substr($item['isi'],0,30)?><a class="tambah" key="<?php echo $item['id']; ?>" style="cursor:pointer;background-color: #68af4a;padding:4px;color:white;font-size:13px;text-decoration:none">READ MORE</a></p>
																									...
																									foreach ($hasil_get as $item) {
																										...
																										<div class="world-news" style="border-bottom:1px solid #eaeaea;padding-bottom:3px">
																											<div class="world-news-grids">
																												...
																												<div >
																													<a href="" class="title"><?php echo substr($item['judul'],0,35)?></a>
																													<a href="" class="tambah" key="<?php echo $item['id']; ?>" >Read More</a>
																												</div>
