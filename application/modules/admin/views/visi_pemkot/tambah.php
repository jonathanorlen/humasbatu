<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/visi_pemkot/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
        success : function(data) {  
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo
            base_url() . 'admin/visi_pemkot/daftar' ?>";},1500);              
        },  
        error : function() {  
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Tambah Visi & Misi Pemerintah
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('admin') . '/dasboard' ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active">Visi & Misi Pemerintah</li>
    </ol>
  </section>
      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="box box-info">
          <div class="box-header">
            ...
            <h3 class="box-title">Tambah Visi & Misi Pemerintah</h3>
            <!-- tools box -->
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              ...
              <div>
                <label>Isi</label>
                <textarea name="isi" class="textarea" placeholder="Deskripsi Visi & Misi Pemerintah" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
              <!-- <div>
