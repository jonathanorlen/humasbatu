...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/struktur/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
			success : function(data) {  
				$(".sukses").html(data);   
				setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'admin/struktur/daftar' ?>";},1500);              
			},  
			error : function() {  
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM struktur where id='$id'");
						$hasil = $get->row();
						?>
