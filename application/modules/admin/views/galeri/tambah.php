<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/galeri/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
        success : function(data) {  
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo
            base_url() . 'admin/galeri/daftar' ?>";},1500);              
        },  
        error : function() {  
        ...
        <div class="box box-info">
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              ...
              <div class="form-group">
                <label>Tanggal</label>
                <input type="date" class="form-control" name="tanggal" placeholder="Tanggal upload" />
              </div>
              <div class="form-group">
                <label>Link</label>
                <input type="text" class="form-control" name="link" placeholder="link upload" />
              </div>  
              <div>
                <label>Isi</label>
                <textarea name="isi" class="textarea" placeholder="Deskripsi Gambar" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div> 
              <div class="form-group">
                <label>Status</label>
              ...
              <label> Keterangan : Ukuran gambar untuk upload foto 900x566</label>
              <div class="box-footer clearfix">
