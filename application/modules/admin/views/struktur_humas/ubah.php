...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/struktur_humas/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
			success : function(data) {  
				$(".sukses").html(data);   
				setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'admin/struktur_humas/daftar' ?>";},1500);              
			},  
			error : function() {  
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Edit Struktur Organisasi Humas
			<!-- <small>Edit Edit Struktur Organisasi Humas</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('admin').'/dasboard' ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li class="active">Edit Struktur Organisasi Humas</li>
		</ol>
	</section>
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Edit Struktur Organisasi Humas</h3>
						<!-- tools box -->
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM struktur_humas where id='$id'");
						$hasil = $get->row();
						?>
