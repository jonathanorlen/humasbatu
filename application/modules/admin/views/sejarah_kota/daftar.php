<div class="content-wrapper" style="min-height: 916px;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Sejarah Kota</li>
    </ol>
  </section>
        ...
        <div class="box">          
          <div class="box-body">
           ...
           <div class="box-footer clearfix">
            <a style="padding:13px;" class="btn btn-app green" href="<?php echo base_url() . 'admin/sejarah_kota/tambah' ?>">
          ...
          <table id="tabel_daftar" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $get_product =$this->db->get("sejarah_kota");
...
$(document).ready(function() {
  ...
  $("a#hapus").click( function() {    
    ...
    if (r==true)
    {
      $.ajax( {  
        type :"post",  
        url :"<?php echo base_url() . 'admin/sejarah_kota/hapus' ?>",  
        cache :false,  
