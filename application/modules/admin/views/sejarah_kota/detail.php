...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Detail Sejarah Kota Batu			
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('admin').'/dasboard' ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li class="active">Detail Sejarah Kota Batu</li>
		</ol>
	</section>
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Detail Sejarah Kota Batu</h3>
						<!-- tools box -->
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM sejarah_kota where id='$id'");
						$hasil = $get->row();
						?>
