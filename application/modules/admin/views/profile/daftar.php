<div class="content-wrapper" style="min-height: 916px;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Profile</li>
    </ol>
  </section>
        ...
        <div class="box">          
          <div class="box-body">
           ...
           <div class="box-footer clearfix">
            <a style="padding:13px;" class="btn btn-app green" href="<?php echo base_url() . 'admin/profile/tambah' ?>">
          ...
          <table id="tabel_daftar" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $get_product = $this->db->get('profil');
...
$(document).ready(function() {
  ...
  $("a#hapus").click( function() {    
    ...
    if (r==true)
    {
      $.ajax( {  
        type :"post",  
        url :"<?php echo base_url() . 'admin/profile/hapus' ?>",  
        cache :false,  
        data :({key:$(this).attr('key')}),
        success : function(data) { 
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'admin/profile/daftar' ?>";},1500);              
        },  
        error : function() {  
