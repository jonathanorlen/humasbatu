...
<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/download/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
             <div class="form-group">
               ...
               <select class="form-control" tabindex="-1" aria-hidden="true" name="jenis_dokumen">
            ...
            <div class="form-group">
              <label>Isi</label>
              <textarea name="isi" placeholder="Deskripsi Data" class="textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            </div>
            <div class="box-footer clearfix">
              <label>Upload Files</label>
              <a class="btn btn-app blue" id="upload_foto">
                <i class="fa fa-edit"></i> Input Files 
              </a>
            </div> 
