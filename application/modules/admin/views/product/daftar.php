        ...
        <div class="box">          
          <div class="box-body">
           ...
           <div class="box-footer clearfix">
            <a style="padding:13px;" class="btn btn-app green" href="<?php echo base_url() . 'admin/product/tambah' ?>">
...
<!--                 <th width="80px;">Status</th> -->
            ...
            <tbody>
              ...
              $get_product = $this->db->get('produk');
...
$(document).ready(function() {
  ...
  $("a#hapus").click( function() {    
    ...
    if (r==true)
    {
      $.ajax( {  
        type :"post",  
        url :"<?php echo base_url() . 'admin/product/hapus' ?>",  
        cache :false,  
