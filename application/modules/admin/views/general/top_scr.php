...
<head>
  <meta charset="UTF-8">
  <title>HUMAS BATU | Dashboard</title>
        ...
        <div class="wrapper" style="background:#e0e0e0">
          ...
          <header class="main-header">
            ...
            <a href="<?php echo base_url('admin') ; ?>" class="logo">
              ...
              <span class="logo-mini"><b>HUMAS BATU</b></span>
              <!-- logo for regular state and mobile devices -->

              <span class="logo-lg"><b>HUMAS BATU</b></span>
            </a>
            <!-- Header Navbar: style can be found in header.less -->
            <nav class="navbar navbar-static-top" role="navigation" style="background:#20873e">
                ...
                <ul class="nav navbar-nav">                                   
                  ...
                  <li class="dropdown user user-menu">  
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <span class="hidden-xs"><?php echo $petugas ?></span>
                    </a>


                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header" style="height:80px;background-color: #20873e !important">
                        <p>
                          HUMAS BATU
