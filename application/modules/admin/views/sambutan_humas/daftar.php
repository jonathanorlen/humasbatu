<div class="content-wrapper" style="min-height: 916px;">
  ...
  <section class="content-header">
    <h1> 
      Daftar Sambutan Humas
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Daftar Sambutan Humas</li>
    </ol>
  </section>
        ...
        <div class="box">          
          <div class="box-body">
           ...
           <div class="box-footer clearfix">
            <a style="padding:13px;" class="btn btn-app green" href="<?php echo base_url() . 'admin/sambutan_humas/tambah' ?>">
          ...
          <table id="tabel_daftar" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <?php 
              $get_product =$this->db->get_where("sambutan",array('jenis_sambutan'=>'humas'));
...
$(document).ready(function() {
  ...
  $("a#hapus").click( function() {    
    ...
    if (r==true)
    {
      $.ajax( {  
        type :"post",  
        url :"<?php echo base_url() . 'admin/sambutan_humas/hapus' ?>",  
        cache :false,  
        data :({key:$(this).attr('key')}),
        success : function(data) { 
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'admin/sambutan_humas/daftar' ?>";},1500);              
        },  
        error : function() {  
