<script type="text/javascript">
	$(function () {
		...
		$("#data_form").submit( function() {    
			$.ajax( {  
				type :"post",  
				url : "<?php echo base_url() . 'admin/sambutan_humas/simpan_ubah' ?>",  
				cache :false,  
				data :$(this).serialize(),
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Edit Sambutan Humas
			<!-- <small>Edit Edit Sambutan Humas</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('admin').'/dasboard' ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li class="active">Edit Sambutan Humas</li>
		</ol>
	</section>
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Edit Sambutan Humas</h3>
						<!-- tools box -->
