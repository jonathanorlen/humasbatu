...
<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/slider/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
        ...
        <div class="box box-info">
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              ...
              <div class="form-group">
                <label>Tanggal </label>
                <input  type="date" class="date-picker form-control" data-date-format="yyyy-mm-dd" name="tgl_event" placeholder="Tanggal" />
              </div>
              ...
              <label>Keterangan : Ukuran gambar untuk upload foto 1098x550</label>
              <div class="box-footer clearfix">
