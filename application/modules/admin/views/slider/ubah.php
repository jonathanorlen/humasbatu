...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/slider/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
				...
				<div class="box box-info">
					...
					<div class="box-body">            
						...
						<form method="post" id="data_form">
							...
							<div class="form-group">
								<label>Tanggal</label>
								<input type="date" class="date-picker form-control" data-date-format="yyyy-mm-dd" name="tgl_event" value="<?php echo $hasil->tanggal; ?>" />
							</div>
							...
							<label>NB: Ukuran gambar untuk upload foto 1098x550</label>
							
							<div class="form-group">
								<label>Link</label>
								<input type="text" class="form-control" name="link" value="<?php echo $hasil->link; ?>" />
							</div>
