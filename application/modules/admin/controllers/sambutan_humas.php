...
class sambutan_humas extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('sambutan_humas/tambah', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function simpan_tambah() {
			
			$data['jenis_sambutan'] = 'humas';
	...
	public function daftar()
	{
		...
		$data['konten'] = $this->load->view('sambutan_humas/daftar', NULL, TRUE);
		$this->load->view('main', $data);
	}

	public function detail()
	{
		$data['konten'] = $this->load->view('sambutan_humas/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function ubah()
	{
		$data['konten'] = $this->load->view('sambutan_humas/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
