...
class sambutan_pers extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('sambutan_pers/tambah', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function simpan_tambah() {
			
			$data['jenis_sambutan'] = 'pers';
	...
	public function daftar()
	{
		...
		$data['konten'] = $this->load->view('sambutan_pers/daftar', NULL, TRUE);
		$this->load->view('main', $data);
	}

	public function detail()
	{
		$data['konten'] = $this->load->view('sambutan_pers/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function ubah()
	{
		$data['konten'] = $this->load->view('sambutan_pers/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
