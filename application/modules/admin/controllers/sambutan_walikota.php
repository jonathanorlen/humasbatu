...
class sambutan_walikota extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('sambutan_walikota/tambah', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function simpan_tambah() {
			
			$data['jenis_sambutan'] = 'walikota';
	...
	public function daftar()
	{
		...
		$data['konten'] = $this->load->view('sambutan_walikota/daftar', NULL, TRUE);
		$this->load->view('main', $data);
	}

	public function detail()
	{
		$data['konten'] = $this->load->view('sambutan_walikota/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function ubah()
	{
		$data['konten'] = $this->load->view('sambutan_walikota/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	public function simpan_ubah() {
			...
			$get_old_file = $this->db->query("SELECT * FROM sambutan where id='$id'");
			...
			//$data['kategori_id'] = $this->input->post("kategori");
			$this->db->update("sambutan", $data, "id = " . $id);
			//echo $this->db->last_query();
	...
	public function hapus() {      
		$key = $_REQUEST['key'];
		$this->db->delete('sambutan', array('id' => $key));
