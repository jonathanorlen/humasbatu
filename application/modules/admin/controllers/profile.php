...
class profile extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('profile/tambah', NULL, TRUE);
	...
	{
		$data['konten'] = $this->load->view('profile/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function ubah()
	{
		$data['konten'] = $this->load->view('profile/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	public function simpan_ubah() {
			...
			$get_old_file = $this->db->query("SELECT * FROM profil where id='$id'");
	...
	public function hapus() {      
		$key = $_REQUEST['key'];
		$this->db->delete('profil', array('id' => $key));
