...
class struktur extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('struktur/tambah', NULL, TRUE);
	...
	{
		//$item = 
		$data['konten'] = $this->load->view('struktur/daftar', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function detail()
	{
		$data['konten'] = $this->load->view('struktur/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}

	public function ubah()
	{
		$data['konten'] = $this->load->view('struktur/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	public function simpan_ubah() {
			...
			$get_old_file = $this->db->query("SELECT * FROM struktur where id='$id'");
	...
	public function hapus() {      
		$key = $_REQUEST['key'];
		$this->db->delete('struktur', array('id' => $key));
